...
const customersInfo = (req, res) => {
	fetch('https://merchantbeware.myshopify.com/admin/api/2024-04/customers.json', {
	  method: 'GET',
	  headers: {
	  ...
	  .then(data => {
		if (data?.customers?.length > 0) {
		  fetch('https://merchantbeware.myshopify.com/admin/api/2024-04/orders.json', {
			method: 'GET',
			headers: {
			  "Content-Type": "application/json",
			  "X-Shopify-Access-Token": process.env.accessToken
...
module.exports = {adminApiHandler,
	customersInfo
}
